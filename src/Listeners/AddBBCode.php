...
$event->configurator->BBCodes->addCustom(
            '[TOGBOX]{COLOR},{COLOR2},{TEXT};{TEXT2};{TEXT3};{TEXT4};{TEXT5};{TEXT6};{TEXT7};{TEXT8};{TEXT9};{TEXT10}[/TOGBOX]',
            '<div id="togbody" style="--main-togbox-bg: {COLOR}; --main-togbox-label: {COLOR2}"><div class="togbox"><div>
    <input id="{TEXT}" type="radio" name="toggle" checked="checked"/>
    <label for="{TEXT}">{TEXT}</label>
    <div class="togcontent">
      <p class="togp">{TEXT2}</p></div>
  </div>
  <div>
    <input id="{TEXT3}" type="radio" name="toggle"/>
    <label for="{TEXT3}">{TEXT3}</label>
    <div class="togcontent">
      <p class="togp">{TEXT4}</p></div>
  </div>
  <div>
    <input id="{TEXT5}" type="radio" name="toggle"/>
    <label for="{TEXT5}">{TEXT5}</label>
    <div class="togcontent">
      <p class="togp">{TEXT6}</p></div>
  </div>
  <div>
    <input id="{TEXT7}" type="radio" name="toggle"/>
    <label for="{TEXT7}">{TEXT7}</label>
    <div class="togcontent">
      <p class="togp">{TEXT8}</p></div>
  </div>
  <div>
    <input id="{TEXT9}" type="radio" name="toggle"/>
    <label for="{TEXT9}">{TEXT9}</label>
    <div class="togcontent">
      <p class="togp">{TEXT10}</p></div>
  </div></div></div>'
        );
